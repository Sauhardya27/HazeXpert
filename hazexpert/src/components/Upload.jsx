...
const Upload = () => {
	return (
		<div className='w-[308px] h-[300px] xs:w-[513px] xs:h-[316px] sm:w-[698px] sm:h-[430px] bg-gradient-to-r from-purpleG to to-whiteG relative sm:left-[42rem] sm:bottom-[47rem] rounded-xl p-[2px] mt-10 xs:mt-0 mx-2 xs:mx-0'>
